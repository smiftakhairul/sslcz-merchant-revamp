...
const chargebackColumns = (currentPage, pageSize, modal) => [
  {
    Header: "#",
    Cell: (row) => (
      ...
      return (
        <div>
          <Button
            ...
            color=""
            title="Details"
            onClick={() => modal(props.row.original, "ChargebackDetail")}
          >
...
export default chargebackColumns;
