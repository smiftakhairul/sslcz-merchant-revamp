      ...
      <Row>
        <Colxx md="12">
          <div className="list-group transaction-list">
            ...
            {listGroupItem('Chargeback Amount', getParseFloat(props.transaction?.chargeback_amt || 0))}
            {listGroupItem('Chargeback Reference ID', props.transaction?.chargeback_ref_id)}
              ...
              props.transaction?.approved_on && props.transaction?.approved_on !== '0000-00-00 00:00:00'
                ? <React.Fragment>
                    ...
                    {listGroupItem('Approval Status', {
                          5: <span className="text-danger">Denied</span>,
                          2: <span className="text-info">Processing</span>,
                          1: <span className="text-success">Success</span>,
                          0: <span className="text-danger">Cancelled</span>,
  ...
  return (
    <React.Fragment>
      <ModalWrapper
        isOpen={props.isOpen}
        toggle={props.toggle}
        modalTitle="Chargeback Information"
