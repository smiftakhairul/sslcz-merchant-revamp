...
const SearchBulkOrderDetails = (props) => {
  ...
  const getFields = async () => {
    setIsLoading(true);
    try {
      await apiClient("bulkOrderDetailsSearchFields", {}, {}).then((response) => {
  ...
  return (
    <div className="">
      <CardWrapper
        isOpen={Object.keys(getSearchParams()).length}
        toggleOn={true}
...
export default SearchBulkOrderDetails;
