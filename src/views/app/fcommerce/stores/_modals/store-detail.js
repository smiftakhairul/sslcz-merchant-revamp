                ...
                <div className="row">
                  <div className="col-md-12">
                    <div className="list-group transaction-list">
                      ...
                      {listGroupItem('Banner', null, 5, 7, false, () => <img src={securePayBaseUrl + '/' + props.store?.banner_path} alt="Banner" width={50} height={50} />)}
                      {listGroupItem('Banner Redirect URL', props.store?.banner_redirect_url)}
                      {listGroupItem('Logo', null, 5, 7, false, () => <img src={securePayBaseUrl + '/' + props.store?.store_logo} alt="Logo" width={50} height={50} />)}
                    </div>
                  </div>
                </div>
              }
