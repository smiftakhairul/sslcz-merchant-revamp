...
module.exports = {
    ...
    "menu.refund-request": "Refund Request",
    "menu.refund": "Refund",
    "menu.request": "Request",
    "menu.new-request": "New Request",
    "menu.new-refund-request": "New Refund Request",
    "menu.chargeback": "Chargeback Request",
    "menu.analytics": "Analytics",
    "menu.invoice-configuration": "Invoice Configuration",
    "menu.payment-link-menu": "Payment Link",
    "menu.payment-link": "Add New Payment Link",
    "menu.payment-link-update": "Update Payment Link",
    "menu.update-link": "Update",
    "menu.payment-link-list": "Payment Link List",
    "menu.payment-list": "Payment List",
    "menu.new-payment-link": "New Payment Link",
    "menu.emi-settings": "EMI Settings",
    "menu.configuration": "Configuration",
    "menu.configuration-list": "Configuration List",
    "menu.recurring": "Recurring",
    "menu.list": "List",
    "menu.update": "Update",
    "menu.update-recurring":"Update",
    "menu.recurring-configuration": "Add New Recurring Configuration",
    "menu.recurring-list": "Recurring List",
    "menu.recurring-configuration-list": "Recurring Configuration List",
    "menu.recurring-configuration-update": "Update Recurring Configuration",
    "menu.new-recurring":"New Recurring Configuration",
    "menu.market-share": "Market Share",
    "menu.geo-location": "Geo Location",
    "menu.mobile-operators": "Mobile Operators",
    "menu.issuer-location": "Issuer Location",
    "menu.user-agent": "User Agent",
    "menu.id-tracking": "ID Tracking",
    "menu.create-user": "Create User",
    "menu.update-user": "Update",
    "menu.update-user-title": "Update User",
    "menu.new-user": "New",
    "menu.store-groups": "Store Groups",
    "menu.groups": "Groups",
    "menu.gateways": "Gateways",
    "menu.discounts": "Discounts",
    "menu.terminal": "Manage Terminal",
    "menu.store-daily-balance": "Store Daily Balance",
    "menu.manage-settlement": "Manage Settlement",
    "menu.create": "Create",
    "menu.subscription": "Manage QR",
    "menu.new-subscription": "Add New QR",
    "menu.update-subscription": "Edit QR",
    
    "form-components.store": "Store",
    "form-components.issuerlocation": "Issuer Location",
    "form-components.emistatus": "Emi Status",
    "form-components.status": "Status",
    "form-components.paymenttype": "Payment Type",
    "form-components.search-to": "Search To",
    ...
    "menu.new-link": "New Link",
    "menu.my-store": "My Stores",
    "menu.createinvoice": "Create Invoice",
    "menu.fcommerce": "Fcommerce",
    "menu.orders": "Orders",
    ...
    "menu.my-users": "My Users",
    "menu.create-invoice": "Create Invoice",

    /* 04.SSLCommerz Menu */
    "menu.sslDashboard": "Dashboard",
    "menu.sslTransaction": "Transactions",
    "menu.sslIDtracking": "ID Tracking",
    "menu.sslRefundRequest": "Refund Request",
    "menu.sslChargebackRequest": "Chargeback Request",
    "menu.sslAccounting": "Accounting",
    "menu.sslModifyPnr": "Modify PNR",
    "menu.pnr": "Modify PNR",
    "menu.sslPnrTitle": "PNR",
    "menu.sslMyUser": "My Users",
    "menu.sslMyStore": "My Store",
    "menu.sslMyStoreList": "Store List",
    "menu.sslMyStoreGroup": "Store Groups",
    "menu.sslMyStoreGateway": "Store Gateways",
    "menu.sslInvoice": "Invoice",
    "menu.sslInvoiceList": "Invoice List",
    "menu.sslAnalytics": "Analytics",
    "menu.sslAnalyticsShare": "Market Share",
    "menu.sslAnalyticsGeo": "GEO Location",
    "menu.sslAnalyticsMobile": "Mobile Operators",
    "menu.sslAnalyticsAgent": "User Agent",
    "menu.sslAnalyticsLocation": "Issuer Location",
    "menu.sslAnalyticsSavedCard": "Saved Card",
    "menu.analytics-saved-card": "Save Card & MOTO Transactions",
    "menu.saved-card": "Save Card",
    "menu.sslFcommerce": "Fcommerce",
    "menu.sslFcommerceOrder": "Order",
    "menu.sslFcommerceProduct": "Product",
    "menu.sslFcommerceCategory": "Category",
    "menu.sslFcommerceBrand": "Brand",
    "menu.sslFcommerceStore": "Store",
    "menu.sslLogistics": "Logistics",
    "menu.ssl-logi-order-list": "Order List",
    "menu.ssl-logi-bulkorder-list": "Bulk Order List",
    "menu.ssl-logi-bulkorder-details-list": "Bulk Order Details List",
    "menu.ssl-logi-pickupstore-list": "Pickup Store List",
    "menu.ssl-logi-billing-list": "Billing List",
    "menu.logistics": "Logistics",
    "menu.bulk-order": "Bulk Order",
    "menu.ssl-logi-bulk-upload": "Bulk Upload",
    "menu.upload": "Bulk Upload",
    "menu.sslFcommerceOrders": "Orders",
    "menu.sslFcommerceProducts": "Products",
    "menu.sslFcommerceCategories": "Categories",
    "menu.sslFcommerceBrands": "Brands",
    "menu.sslFcommerceStores": "Stores",
